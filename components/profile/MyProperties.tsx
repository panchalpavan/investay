        ...
        {({ open }) => (
          <>
            <Disclosure.Button className="w-full flex justify-between items-end bg-gray-100 p-2 mb-5">
              <p className="text-sm font-bold">My Property Details</p>
              {/* <Disclosure.Button> */}
              {open ? (
                    ...
                    return (
                      ...
                      >
                        <div className="lg:col-span-4 sm:col-span-6  col-span-12  h-full  shadow-md flex flex-col rounded-lg">
                          <div className="h-28 xxs:h-[10rem] w-full relative overflow-hidden">
                            <p
                              className={`${
                            ...
                            {property?.saleStatus !== "available" && (
                              <p className="absolute top-0 right-[-2rem] min-w-[180px] p-2 text-sm text-white flex justify-center items-center rotate-30 origin-center bg-red-600">
