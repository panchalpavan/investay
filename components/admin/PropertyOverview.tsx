...
const PropertyOverview = ({ property }: any) => {
  ...
  const [overview, setOverview] = useState({
    category: property?.category || categories[0].value,
    status: property?.status || propertyStatus[0].value,
    gatedCommunity: property?.gatedCommunity || gatedCommunities[0].value,
    propertyType: property?.propertyType || propertyTypes[0].value,
    sba: property?.sba || "",
    plotArea: property?.plotArea || "",
    carpetArea: property?.carpetArea || "",
    plotConfiguration: property?.plotConfiguration || configurations[0].value,
    constructionStatus: property?.constructionStatus || construction_Status[0].value,
    directionFacing: property?.directionFacing || directionFacings[0].value,
    configuration: property?.configuration || configurations[0].value,
    furnishingType: property?.furnishingType || furnishingTypes[0].value,
    availableFrom: property?.availableFrom || available_From[0].value,
    postedOn: property?.postedOn || postedDate.toDateString(),
    propertyId: router?.query?._id,
    cpName: property?.cpName || "",
    propertyLimits: property?.propertyLimits || property_Limits[0].value,
    reraNo: property?.reraNo || "",
  });

  const [projectDetails, setProjectDetails] = useState({
    propertyAge: property?.propertyAge || propertyAges[0].value,
    projectName: property?.projectName || "",
    builderName: property?.builderName || "",
    waterSupply: property?.waterSupply || waterSupplies[0].value,
    launchDate: property?.launchDate || launchDate.toDateString(),
    visitorParking: property?.visitorParking || false,
    brochure: property?.brochure || "",
  });

  const [unitDetails, setUnitDetails] = useState({
    noOfOwners: property?.noOfOwners || 1,
    khataInOwnersName: property?.khataInOwnersName || false,
    lastTaxPaid: property?.lastTaxPaid || "",
    ownerName: property?.ownerName || "",
    ownerContact: property?.ownerContact || "",
    towerWing: property?.towerWing || "",
    phase: property?.phase || "",
    floor: property?.floor || "",
    totalFloor: property?.totalFloor || "",
    unitName: property?.unitName || "",
    doorFacing: property?.doorFacing || "",
    noOfBathrooms: property?.noOfBathrooms || 1,
    parking: property?.parking || false,
    balcony: property?.balcony || false,
    flooring: property?.flooring || floorings[0].value,
    noOfParking: property?.noOfParking || 1,
    parkingType: property?.parkingType || parkingTypes[0].value,
    propertyAddressZone: property?.propertyAddressZone || propertyAddressZones[0].value,
    city: property?.city || "",
    state: property?.state || states[0].value,
    propertyAddress: property?.propertyAddress || "",
    country: property?.country || countries[0].value,
    nearestLandmark: property?.nearestLandmark || "",
    propertyLocation: property?.propertyLocation || "",
    pincode: property?.pincode || "",
    lat: property?.lat || "",
    lng: property?.lng || "",
    snagDetails: property?.snagDetails || "",
    repairs: property?.repairs || "",
  });

  const [amenities, setAmenities] = useState({
    cyclingTrack: property?.amenities?.cyclingTrack || false,
    yogaDeck: property?.amenities?.yogaDeck || false,
    outdoorGym: property?.amenities?.outdoorGym || false,
    indoorGym: property?.amenities?.indoorGym || false,
    yogaRoom: property?.amenities?.yogaRoom || false,
    spa: property?.amenities?.spa || false,
    steamAndSauna: property?.amenities?.steamAndSauna || false,
    kidsPool: property?.amenities?.kidsPool || false,
    swimmingPool: property?.amenities?.swimmingPool || false,
    aerobicsStudio: property?.amenities?.aerobicsStudio || false,
    badmintonCourt: property?.amenities?.badmintonCourt || false,
    basketballCourt: property?.amenities?.basketballCourt || false,
    volleyballCourt: property?.amenities?.volleyballCourt || false,
    squashCourt: property?.amenities?.squashCourt || false,
    tennisCourt: property?.amenities?.tennisCourt || false,
    tableTennis: property?.amenities?.tableTennis || false,
    boxCricket: property?.amenities?.boxCricket || false,
    golf: property?.amenities?.golf || false,
    multipurposeCourt: property?.amenities?.multipurposeCourt || false,
    billiards: property?.amenities?.billiards || false,
    skatingRink: property?.amenities?.skatingRink || false,
    playArea: property?.amenities?.playArea || false,
    library: property?.amenities?.library || false,
    creche: property?.amenities?.creche || false,
    danceStudio: property?.amenities?.danceStudio || false,
    videoGameRoom: property?.amenities?.videoGameRoom || false,
    adventureSports: property?.amenities?.adventureSports || false,
    oat: property?.amenities?.oat || false,
    miniTheatre: property?.amenities?.miniTheatre || false,
    preFunctionHall: property?.amenities?.preFunctionHall || false,
    banquetHall: property?.amenities?.banquetHall || false,
    cafe: property?.amenities?.cafe || false,
    barbecuePit: property?.amenities?.barbecuePit || false,
    parks: property?.amenities?.parks || false,
    seniorCitizenCorner: property?.amenities?.seniorCitizenCorner || false,
    natureTrail: property?.amenities?.natureTrail || false,
    terraceGarden: property?.amenities?.terraceGarden || false,
    ac: property?.amenities?.ac || false,
    intercom: property?.amenities?.intercom || false,
    internet: property?.amenities?.internet || false,
    petPark: property?.amenities?.petPark || false,
    gatedSecurity: property?.amenities?.gatedSecurity || false,
    cctv: property?.amenities?.cctv || false,
    visitorParking: property?.amenities?.visitorParking || false,
    fireAlarm: property?.amenities?.fireAlarm || false,
    fireExtinguisher: property?.amenities?.fireExtinguisher || false,
    waterSprinkler: property?.amenities?.waterSprinkler || false,
    rainwaterHarvesting: property?.amenities?.rainwaterHarvesting || false,
    organicWasteConverter: property?.amenities?.organicWasteConverter || false,
    solarHeater: property?.amenities?.solarHeater || false,
    solarLighting: property?.amenities?.solarLighting || false,
    electricCarCharging: property?.amenities?.electricCarCharging || false,
    sewageTreatmentPlant: property?.amenities?.sewageTreatmentPlant || false,
    atm: property?.amenities?.atm || false,
    lift: property?.amenities?.lift || false,
    supermarket: property?.amenities?.supermarket || false,
    coWorkingSpace: property?.amenities?.coWorkingSpace || false,
    pharmacy: property?.amenities?.pharmacy || false,
    salon: property?.amenities?.salon || false,
    conferenceRoom: property?.amenities?.conferenceRoom || false,
    laundry: property?.amenities?.laundry || false,
    groceryStore: property?.amenities?.groceryStore || false,
    houseKeeping: property?.amenities?.houseKeeping || false,
    powerBackup: property?.amenities?.powerBackup || false,
    gasPipeline: property?.amenities?.gasPipeline || false,
    garbageChute: property?.amenities?.garbageChute || false,
  });

  const [tenancyInformation, setTenancyInformation] = useState({
    tenancyStatus: property?.tenancyStatus || tenancy_Status[0].value,
    tenantType: property?.tenantType || tenancyTypes[0].value,
    securityDeposit: property?.securityDeposit || "",
    tenancyExitStatus: property?.tenancyExitStatus || tenancy_ExitStatus[0].value,
  ...
  const onSubmitHandler = async (e: any) => {
    ...
    try {
      ...
      if (response.success) {
        setLoading(false);
        router.push("/admin/booking-and-pricing-info/" + router?.query?._id);
      }
    } catch (error: any) {
  ...
  return (
    <div
      id="property-overview-page"
      className="flex flex-col items-start justify-start"
    >
      <Disclosure as={"div"} className="w-full " defaultOpen={true} id="property-overview">
        {({ open }) => (
          <>
              ...
              <div className="grid grid-cols-12 gap-x-5 gap-y-2 mb-5">
                ...
                <div className="md:col-span-4  xxs:col-span-6  col-span-12">
                  ...
                  <Listbox
                    ...
                    onChange={(val) =>
                      setOverview({ ...overview, status: val })
                    }
                  >
                    <div className="relative flex border border-secondaryLightColor w-full py-[0.3rem] mt-1  rounded-md">
                      <Listbox.Button className="cursor-pointer focus:outline-none  rounded-md w-full flex justify-between items-center px-2">
                        <span className="text-base capitalize text-secondaryLightColor">
                          {
                            propertyStatus.find(
                              (item: any) => item.value === overview.status
                            )?.name
                          }
                        </span>
      ...
      <Disclosure as={"div"} className="w-full" defaultOpen={true} id="project-details">
        {({ open }) => (
          <>
            <Disclosure.Button className="w-full flex justify-between items-end bg-gray-100 p-2 mb-5">
            ...
            <Disclosure.Panel>
              <div className="grid grid-cols-12 gap-x-5 gap-y-2 mb-5">
                ...
                <div className="md:col-span-4  xxs:col-span-6  col-span-12">
                  ...
                  <div className="flex  justify-between mt-1">
                    <div
                      ...
                      className={`cursor-pointer border border-secondaryLightColor mr-2 text-center w-full rounded-md h-full px-8 py-2 ${projectDetails.visitorParking
                        ? "bg-[#fdb813]"
                        : "bg-white"
                        }`}
                    >
                    ...
                    <div
                      ...
                      className={`cursor-pointer border  w-full ml-2 border-secondaryLightColor  text-center rounded-md h-full px-8 py-2 ${!projectDetails.visitorParking
                        ? "bg-[#fdb813]"
                        : "bg-white"
                        }`}
                    >
                ...
                <div className="md:col-span-4  xxs:col-span-6  col-span-12">
                  ...
                  <div
                    className={`border border-secondaryLightColor text-secondaryLightColor  py-2 px-2 flex items-center mt-1   rounded-md ${projectDetails.brochure === "" || !projectDetails.brochure
                      ? "bg-white"
                      : "bg-[#fdb813]"
                      }`}
                  >
      ...
      <Disclosure as={"div"} className="w-full" defaultOpen={true} id="unit-details">
        {({ open }) => (
          <>
            <Disclosure.Button className="w-full flex justify-between items-end bg-gray-100 p-2 mb-5">
                ...
                <div className="md:col-span-4  xxs:col-span-6  col-span-12">
                  ...
                  <div className="flex  justify-between mt-1">
                    <div
                      ...
                      className={`cursor-pointer border w-full text-center mr-2 border-secondaryLightColor rounded-md h-full px-8 py-2 ${unitDetails.khataInOwnersName
                        ? "bg-[#fdb813]"
                        : "bg-white"
                        }`}
                    >
                    ...
                    <div
                      ...
                      className={`cursor-pointer border w-full text-center ml-2 border-secondaryLightColor rounded-md h-full px-8 py-2 ${!unitDetails.khataInOwnersName
                        ? "bg-[#fdb813]"
                        : "bg-white"
                        }`}
                    >
                ...
                <div className="md:col-span-4  xxs:col-span-6  col-span-12">
                  ...
                  <div className="flex justify-between mt-1">
                    <div
                      ...
                      className={`cursor-pointer border w-full text-center mr-2 border-secondaryLightColor rounded-md h-full px-8 py-2 ${unitDetails.parking ? "bg-[#fdb813]" : "bg-white"
                        }`}
                    >
                      Yes
                    </div>
                    <div
                      ...
                      className={`cursor-pointer border border-secondaryLightColor w-full text-center ml-2 rounded-md h-full px-8 py-2 ${!unitDetails.parking ? "bg-[#fdb813]" : "bg-white"
                        }`}
                    >
                      No
                    </div>
                ...
                <div className="md:col-span-4  xxs:col-span-6  col-span-12">
                  ...
                  <div className="flex  justify-between mt-1">
                    <div
                      ...
                      className={`cursor-pointer border border-secondaryLightColor w-full text-center mr-2 rounded-md h-full px-8 py-2 ${unitDetails.balcony ? "bg-[#fdb813]" : "bg-white"
                        }`}
                    >
                      Yes
                    </div>
                    <div
                      ...
                      className={`cursor-pointer border border-secondaryLightColor w-full text-center ml-2 rounded-md h-full px-8 py-2 ${!unitDetails.balcony ? "bg-[#fdb813]" : "bg-white"
                        }`}
                    >
                      No
                    </div>
      ...
      <Disclosure as={"div"} className="w-full" defaultOpen={true} id="gallery-menu">
        {({ open }) => (
          <>
            <Disclosure.Button className="w-full flex justify-between items-end bg-gray-100 p-2 mb-5">
              <p className="text-base font-bold"> Gallery Menu</p>
              {open ? (
                <ChevronUpIcon className="font-semibold  w-5 h-5 cursor-pointer" />
              ) : (
                <ChevronDownIcon className="font-semibold  w-5 h-5 cursor-pointer" />
            ...
            <Disclosure.Panel>
              <div className="grid grid-cols-12 gap-x-5 gap-y-2 mb-5">
                <div className="col-span-12 px-2 ">
                  ...
                  <div className="grid xl:grid-cols-6 lg:grid-cols-5 md:grid-cols-4 grid-cols-3 text-left gap-x-10 gap-y-5 mt-1">
      ...
      <Disclosure as={"div"} className="w-full" defaultOpen={true} id="amenities">
        {({ open }) => (
          <>
            <Disclosure.Button className="w-full flex justify-between items-end bg-gray-100 p-2 mb-5">
              <p className="text-base font-bold">Amenities</p>
              {open ? (
                <ChevronUpIcon className="font-semibold  w-5 h-5 cursor-pointer" />
              ) : (
                <ChevronDownIcon className="font-semibold  w-5 h-5 cursor-pointer" />
      ...
      <Disclosure as={"div"} className="w-full" defaultOpen={true} id="property-documents">
        {({ open }) => (
          <>
            <Disclosure.Button className="w-full flex justify-between items-end bg-gray-100 p-2 mb-5">
              <p className="text-base font-bold">Property Documents</p>
              {open ? (
                <ChevronUpIcon className="font-semibold  w-5 h-5 cursor-pointer" />
              ) : (
                <ChevronDownIcon className="font-semibold  w-5 h-5 cursor-pointer" />
      ...
      <Disclosure as={"div"} className="w-full" defaultOpen={true} id="tenant-infomation">
        {({ open }) => (
          <>
            <Disclosure.Button className="w-full flex justify-between items-end bg-gray-100 p-2 mb-5">
              <p className="text-base font-bold">Tenant Information</p>
              {open ? (
                <ChevronUpIcon className="font-semibold  w-5 h-5 cursor-pointer" />
              ) : (
                <ChevronDownIcon className="font-semibold  w-5 h-5 cursor-pointer" />
                ...
                <div className="md:col-span-4  xxs:col-span-6  col-span-12">
                  ...
                  <div className="flex justify-between mt-1">
                    <div
                      ...
                      className={`cursor-pointer border text-center w-full mr-2 border-secondaryLightColor rounded-md h-full px-8 py-2 ${tenancyInformation.petsAllowed
                        ? "bg-[#fdb813]"
                        : "bg-white"
                        }`}
                    >
                    ...
                    <div
                      ...
                      className={`cursor-pointer border text-center w-full ml-2 border-secondaryLightColor rounded-md h-full px-8 py-2 ${!tenancyInformation.petsAllowed
                        ? "bg-[#fdb813]"
                        : "bg-white"
                        }`}
                    >
                ...
                <div className="md:col-span-4  xxs:col-span-6  col-span-12">
                  ...
                  <div className="flex justify-between mt-1">
                    <div
                      ...
                      className={`cursor-pointer border text-center w-full mr-2 border-secondaryLightColor rounded-md h-full px-8 py-2 ${tenancyInformation.nonVegAllowed
                        ? "bg-[#fdb813]"
                        : "bg-white"
                        }`}
                    >
                    ...
                    <div
                      ...
                      className={`cursor-pointer border text-center w-full ml-2 border-secondaryLightColor rounded-md h-full px-8 py-2 ${!tenancyInformation.nonVegAllowed
                        ? "bg-[#fdb813]"
                        : "bg-white"
                        }`}
                    >
      ...
      <button
        ...
        className="self-center bg-black text-primaryColor mt-10 rounded-md py-2 px-4  font-bold"
      >
        NEXT
      </button>
